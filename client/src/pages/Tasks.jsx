  ...
  return (
    <div className="space-y-5">
      ...
      <div className="hidden md:block">
        {view === 'kanban' ? <KanbanBoard tasks={tasks} onOpenEditTask={onOpenEditTask} onOpenSubmitWork={onOpenSubmitWork} onOpenReview={setReviewTask} onStartTask={(id) => updateStatus(id, 'IN_PROGRESS')} /> : <TaskTable tasks={tasks} onOpenEditTask={onOpenEditTask} onOpenSubmitWork={onOpenSubmitWork} onOpenReview={setReviewTask} onStartTask={(id) => updateStatus(id, 'IN_PROGRESS')} onDeleteTask={deleteTask} />}
      </div>
