        ...
        <div className="p-6 space-y-4 text-xs">
          ...
          <div className="p-4 bg-emerald-50/50 border border-emerald-200 rounded-2xl flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-2 bg-emerald-700 hover:bg-emerald-600 text-white rounded-xl font-bold flex items-center space-x-1.5 shadow-sm transition-colors shrink-0"
            >
          ...
          <form onSubmit={handleUpload} className="space-y-4">
            <div>
              ...
              <div className="border-2 border-dashed border-slate-300 rounded-2xl p-6 text-center hover:border-emerald-500 transition-colors bg-slate-50/50">
                ...
                />
                {file && (
                  <p className="text-emerald-700 font-bold text-xs mt-2">
